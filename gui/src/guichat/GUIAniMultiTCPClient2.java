...
class GUIAniMultiTCPClient2 {
	...
	GUIAniMultiTCPClient2() {// コンストラクター
		...
		sleep5();
		doClientAccess(hostname, "face,emotion,1,normal");
		sleep5();
		doClientAccess(hostname, "face,emotion,2,angry");
		sleep5();
		...
		while (true) {
			try {
				...
				System.out.println("face,emotion,0,nomal");
				System.out.println("face,emotion,1,smile");
				System.out.println("face,emotion,2,angry");
				System.out.println(":");
